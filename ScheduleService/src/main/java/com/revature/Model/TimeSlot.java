...
public class TimeSlot {
    ...
    public TimeSlot(Integer DoctorId, LocalDate dateAvailable, LocalTime startTime, LocalTime endTime) {
    ...
    public TimeSlot(LocalTime startTime, LocalTime endTime, LocalDate dateAvailable, Integer DoctorId) {
        this.doctorId = DoctorId;
        this.dateAvailable = dateAvailable;
        this.startTime = startTime;
        this.endTime = startTime != null ? startTime.plusMinutes(30) : endTime;
